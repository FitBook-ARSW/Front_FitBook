...
const Publication = props => {
    return (
        <div class="min-h-screen min-w-screen bg-white flex items-center justify-center">
            <div>
                <div class="flex flex-col max-w-md bg-gray-500 px-8 py-6 rounded-xl space-y-5 items-center">
